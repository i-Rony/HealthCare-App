...
import { Text, TouchableOpacity, View, StyleSheet, Image, Modal, TextInput, StatusBar } from "react-native";
        ...
        <View style={styles.topContainer}>
          ...
          <View style={styles.user}>
            ...
            <View style={styles.userInfo}>
              ...
              <View style={styles.userContainer}>
                <Text style={styles.userNo}>000 000 0000</Text>
              </View>
          ...
          <View style={{ padding: '2%', marginTop: '2%' }} >
            <TouchableOpacity style={styles.button} onPress={() => setModalOpen(true)}>
              ...
              <View style={styles.buttonImage}>
                <FontAwesomeIcon icon={faPlusCircle} style={styles.plusCircle} size={35}/>
              </View>
