        ...
        <View style={styles.container}>
            ...
            <View style={styles.topContainer}>
                <View style={styles.nurseContainer}>
                    ...
                    <Text style={styles.birmingham}>Kolkata</Text>
                </View>

                <View style={styles.donatePM}>
                    <View style={styles.rect}>
                        <Text style={styles.supportText}>PM Cares needs your support. To find out how you can help,{" "}
                            <Text style={styles.supportClick} onPress={() => Linking.openURL('https://www.pmcares.gov.in/en/')}>click here.</Text>
                        </Text>
                    </View>
                </View>
            </View>
